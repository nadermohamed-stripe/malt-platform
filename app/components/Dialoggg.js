...
const Dialoggg = ({ open, onClose, selectedPaymentIntent }) => {
  return (
    <div
        ...
        >
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
  <pre>{selectedPaymentIntent ? JSON.stringify(selectedPaymentIntent, null, 2) : 'No payment intent selected'}</pre>
</div>
            </div>
          </div>
